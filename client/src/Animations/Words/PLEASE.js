export const PLEASE = (ref) => {
    ...
    animations.push(["mixamorigRightHandRing1", "rotation", "y", Math.PI/16, "-"]);
    animations.push(["mixamorigRightHandPinky1", "rotation", "y", Math.PI/116, "+"]);
    animations.push(["mixamorigRightHandThumb1", "rotation", "y", Math.PI/16, "-"]);
    animations.push(["mixamorigRightHandThumb2", "rotation", "z", Math.PI/16, "+"]);
    animations.push(["mixamorigRightHandThumb3", "rotation", "y", Math.PI/16, "-"]);
    ...
    animations.push(["mixamorigLeftHandRing1", "rotation", "y", Math.PI/16, "+"]);
    animations.push(["mixamorigLeftHandPinky1", "rotation", "y", Math.PI/16, "-"]);
    animations.push(["mixamorigLeftHandThumb1", "rotation", "y", Math.PI/16, "+"]);
    animations.push(["mixamorigLeftHandThumb2", "rotation", "z", Math.PI/16, "-"]);
    animations.push(["mixamorigLeftHandThumb3", "rotation", "y", Math.PI/16, "+"]);
